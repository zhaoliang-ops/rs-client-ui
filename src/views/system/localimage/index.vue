  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="localimageList" @selection-change="handleSelectionChange">
      ...
      <template slot-scope="scope">
            <span>G:\study\graduation design\code\downloadRsData\{{ scope.row.productName }}</span>
      </template>
       </el-table-column>
      <el-table-column label="数据大小" align="center" prop="dataSize" />
      <el-table-column label="拍摄日期" align="center" prop="createDate" width="180">
        <template slot-scope="scope">
...
<script>
import { listLocalimage, getLocalimage, delLocalimage, addLocalimage, updateLocalimage } from "@/api/system/localimage";
